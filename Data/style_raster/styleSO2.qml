...
<qgis hasScaleBasedVisibilityFlag="0" maxScale="0" version="3.28.3-Firenze" styleCategories="AllStyleCategories" minScale="1e+08">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" alphaBand="-1" nodataColor="" band="1" type="paletted">
      ...
      <colorPalette>
        <paletteEntry value="0" color="#ffffb2" alpha="255" label="-0.000236 - 0.000145"/>
        <paletteEntry value="1" color="#fee281" alpha="255" label="0.000145 - 0.000263"/>
        <paletteEntry value="2" color="#fec357" alpha="255" label="0.000263 - 0.000365"/>
        <paletteEntry value="3" color="#fd9f45" alpha="255" label="0.000365 - 0.00047"/>
        <paletteEntry value="4" color="#f97634" alpha="255" label="0.00047 - 0.000588"/>
        <paletteEntry value="5" color="#f24724" alpha="255" label="0.000588 - 0.000735"/>
        <paletteEntry value="6" color="#da2223" alpha="255" label="0.000735 - 0.001133"/>
        <paletteEntry value="7" color="#bd0026" alpha="255" label="0.001133"/>
      </colorPalette>
