...
<qgis hasScaleBasedVisibilityFlag="0" maxScale="0" version="3.28.3-Firenze" styleCategories="AllStyleCategories" minScale="1e+08">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" alphaBand="-1" nodataColor="" band="1" type="paletted">
      ...
      <colorPalette>
        <paletteEntry value="0" color="#ffffb2" alpha="255" label="0.028158 - 0.029574"/>
        <paletteEntry value="1" color="#fee281" alpha="255" label="0.029574 - 0.030295"/>
        <paletteEntry value="2" color="#fec357" alpha="255" label="0.030295 - 0.030945"/>
        <paletteEntry value="3" color="#fd9f45" alpha="255" label="0.030945 - 0.031532"/>
        <paletteEntry value="4" color="#f97634" alpha="255" label="0.031532 - 0.032103"/>
        <paletteEntry value="5" color="#f24724" alpha="255" label="0.032103 - 0.03279"/>
        <paletteEntry value="6" color="#da2223" alpha="255" label="0.03279 - 0.034463"/>
        <paletteEntry value="7" color="#bd0026" alpha="255" label="0.034463"/>
      </colorPalette>
