...
<qgis hasScaleBasedVisibilityFlag="0" labelsEnabled="0" symbologyReferenceScale="-1" maxScale="0" version="3.28.3-Firenze" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingHints="0" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0">
  <flags>
  ...
  <renderer-v2 symbollevels="0" forceraster="0" referencescale="-1" type="singleSymbol" enableorderby="0">
    <symbols>
      <symbol is_animated="0" alpha="1" force_rhr="0" frame_rate="10" type="marker" name="0" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer class="SimpleMarker" pass="0" locked="0" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="13,13,240,255" type="QString" name="color"/>
            <Option value="1" type="QString" name="horizontal_anchor_point"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
  ...
  <DiagramLayerSettings showAll="1" zIndex="0" obstacle="0" dist="0" linePlacementFlags="18" placement="0" priority="0">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0" field="fclass"/>
